...
namespace HellsGate.Migrations
{
    ...
    [Migration("20200418204853_Dev004")]
    partial class Dev004
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HellsGate.Models.DatabaseModel.CarAnagraphicModel", b =>
                {
                    b.HasOne("HellsGate.Models.DatabaseModel.PeopleAnagraphicModel", "Owner")
                        .WithMany("Cars")
                    ...
                    b.OwnsOne("HellsGate.Models.DatabaseModel.AutorizationLevelModel", "AutorizationLevel", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("LastCreated")
                                .HasColumnType("datetime2");

                            b1.Property<string>("LastCreatedBy")
                                .HasColumnType("nvarchar(max)");
